...
class CampaignRunRepository(AuditEnvironmentMixinRepository[CampaignRun]):
    """Repositorio para la entidad CampaignRun."""

    def __init__(self, session: Session):
        super().__init__(session, CampaignRun)

    def create(self, data: dict, environment_id: int, modified_by: str) -> CampaignRun:
        ...
        try:
            ...
            campaign_run = self.create_with_audit_env(campaign_run_data, environment_id, modified_by)
    ...
    def finalize(self, campaign_run_id: int, notes: str = None) -> CampaignRun:
