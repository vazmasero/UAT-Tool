...
class Ui_form_bug(object):
    def setupUi(self, form_bug):
        ...
        self.cb_status = QComboBox(form_bug)
    ...
    def retranslateUi(self, form_bug):
        ...
        self.cb_status.setItemText(2, QCoreApplication.translate("form_bug", u"ON HOLD", None))
        self.cb_status.setItemText(3, QCoreApplication.translate("form_bug", u"SOLVED", None))
        self.cb_status.setItemText(4, QCoreApplication.translate("form_bug", u"CLOSED", None))
        self.cb_status.setItemText(5, QCoreApplication.translate("form_bug", u"CLOSED BY INDRA", None))
        self.cb_status.setItemText(6, QCoreApplication.translate("form_bug", u"UNSOLVED", None))

        self.cb_status.setPlaceholderText(QCoreApplication.translate("form_bug", u"[Status]", None))
        ...
        self.cb_urgency.setItemText(2, QCoreApplication.translate("form_bug", u"Low - 3", None))

        self.cb_urgency.setPlaceholderText(QCoreApplication.translate("form_bug", u"[Urgency]", None))
        self.lbl_impact.setText(QCoreApplication.translate("form_bug", u"Impact:", None))
        self.cb_impact.setItemText(0, QCoreApplication.translate("form_bug", u"High - 1", None))
        self.cb_impact.setItemText(1, QCoreApplication.translate("form_bug", u"Medium - 2", None))
        self.cb_impact.setItemText(2, QCoreApplication.translate("form_bug", u"Low - 3", None))

        self.cb_impact.setPlaceholderText(QCoreApplication.translate("form_bug", u"[Impact]", None))
