...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.tab_uhub_orgs = QWidget()
        self.tab_uhub_orgs.setObjectName(u"tab_uhub_orgs")
        self.verticalLayout_9 = QVBoxLayout(self.tab_uhub_orgs)
        self.verticalLayout_9.setObjectName(u"verticalLayout_9")
        self.verticalLayout_9.setContentsMargins(0, 0, 0, 0)
        self.tbl_uhub_orgs = QTableView(self.tab_uhub_orgs)
        self.tbl_uhub_orgs.setObjectName(u"tbl_uhub_orgs")

        self.verticalLayout_9.addWidget(self.tbl_uhub_orgs)

        self.tab_widget_assets.addTab(self.tab_uhub_orgs, "")
        self.tab_uhub_users = QWidget()
        self.tab_uhub_users.setObjectName(u"tab_uhub_users")
        self.verticalLayout_10 = QVBoxLayout(self.tab_uhub_users)
        self.verticalLayout_10.setSpacing(6)
        self.verticalLayout_10.setObjectName(u"verticalLayout_10")
        self.verticalLayout_10.setContentsMargins(0, 0, 0, 0)
        self.tbl_uhub_users = QTableView(self.tab_uhub_users)
        self.tbl_uhub_users.setObjectName(u"tbl_uhub_users")

        self.verticalLayout_10.addWidget(self.tbl_uhub_users)

        self.tab_widget_assets.addTab(self.tab_uhub_users, "")
    ...
    def retranslateUi(self, main_window):
        ...
        self.tab_widget_assets.setTabText(self.tab_widget_assets.indexOf(self.tab_uhub_orgs), QCoreApplication.translate("main_window", u"U-hub Organizations", None))
        self.tab_widget_assets.setTabText(self.tab_widget_assets.indexOf(self.tab_uhub_users), QCoreApplication.translate("main_window", u"U-hub Users", None))
