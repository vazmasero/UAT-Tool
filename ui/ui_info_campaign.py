...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayout_3.setContentsMargins(5, -1, 350, -1)
        ...
        self.creation_time_lbl = QLabel(self.tab_bug_info)
        self.creation_time_lbl.setObjectName(u"creation_time_lbl")

        self.horizontalLayout_4.addWidget(self.creation_time_lbl)

        self.creation_time_le = QLineEdit(self.tab_bug_info)
        self.creation_time_le.setObjectName(u"creation_time_le")

        self.horizontalLayout_4.addWidget(self.creation_time_le)

        self.last_update_lbl = QLabel(self.tab_bug_info)
        self.last_update_lbl.setObjectName(u"last_update_lbl")

        self.horizontalLayout_4.addWidget(self.last_update_lbl)

        self.last_update_le = QLineEdit(self.tab_bug_info)
        self.last_update_le.setObjectName(u"last_update_le")

        self.horizontalLayout_4.addWidget(self.last_update_le)

        self.last_update_lbl_2 = QLabel(self.tab_bug_info)
        self.last_update_lbl_2.setObjectName(u"last_update_lbl_2")

        self.horizontalLayout_4.addWidget(self.last_update_lbl_2)

        self.last_update_le_2 = QLineEdit(self.tab_bug_info)
        self.last_update_le_2.setObjectName(u"last_update_le_2")

        self.horizontalLayout_4.addWidget(self.last_update_le_2)

        self.last_update_lbl_3 = QLabel(self.tab_bug_info)
        self.last_update_lbl_3.setObjectName(u"last_update_lbl_3")

        self.horizontalLayout_4.addWidget(self.last_update_lbl_3)

        self.last_update_le_3 = QLineEdit(self.tab_bug_info)
        self.last_update_le_3.setObjectName(u"last_update_le_3")

        self.horizontalLayout_4.addWidget(self.last_update_le_3)
        ...
        self.tabBugs.setCurrentIndex(1)
    ...
    def retranslateUi(self, Form):
        ...
        self.creation_time_lbl.setText(QCoreApplication.translate("Form", u"Creation time:", None))
        self.creation_time_le.setText("")
        self.creation_time_le.setPlaceholderText(QCoreApplication.translate("Form", u"[Creation time]", None))
        self.last_update_lbl.setText(QCoreApplication.translate("Form", u"Last update:", None))
        self.last_update_le.setText("")
        self.last_update_le.setPlaceholderText(QCoreApplication.translate("Form", u"[Last update]", None))
        self.last_update_lbl_2.setText(QCoreApplication.translate("Form", u"Start date:", None))
        self.last_update_le_2.setText("")
        self.last_update_le_2.setPlaceholderText(QCoreApplication.translate("Form", u"[Start date]", None))
        self.last_update_lbl_3.setText(QCoreApplication.translate("Form", u"End date:", None))
        self.last_update_le_3.setText("")
        self.last_update_le_3.setPlaceholderText(QCoreApplication.translate("Form", u"[End date]", None))
