...
class BlockController:
    ...
    def __init__(self, service: BlockService,
                 table_manager: TableManager = None):
        
        """Initizializes the block page controller.
    ...
    def setup_tables(self, ui, _mode, _db_id):
        table_name = 'cases'
        ...
        self.table_manager.setup_table(
            table_widget, table_name, data=None, register=True)
    ...
    def handle_form_submission(
            self, form_data: Dict, db_id: Optional[int], _cases_table=None) -> None:
        ...
        # Obtiene los IDs de los casos seleccionados (ya vienen en
        # form_data['cases'])
